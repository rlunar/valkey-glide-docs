...
For modules without dedicated wrappers, you can still access any loaded module's functionality directly using the [Custom Commands API](/concepts/custom-commands).
:::
...
corresponding module command and executes it via the [Custom Commands API](/concepts/custom-commands).
